...
Sí, la app está optimizada para usarse desde el navegador del móvil. Incluso puedes instalarla como una app independiente (PWA).
...
[Accede a ROCA App](#) y empieza a cerrar más tratos hoy mismo.
